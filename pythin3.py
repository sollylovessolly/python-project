...
def main():
    ...
    while True:
        ...
        if choice == '1':
            initemail = input("Enter email: ")
            initnumber = input("Enter your phone number in this format(08012345678): ")
            
            while True:
                initpassword = input("Enter password: ")
                confirmPassword = input("Re-enter password: ")
                if initpassword == confirmPassword:
                    break
                else:
                    print("Passwords do not match, re-enter password.")
            email = initemail.strip()
            password = initpassword.strip()
            number = initnumber.strip()
